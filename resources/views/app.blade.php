...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-slate-950">
    <head>
        ...
        <title inertia>{{ config('app.name', 'PharmaCare AI - Modern Pharmacy Management') }}</title>
    ...
    <body class="font-sans antialiased h-full bg-slate-950 text-slate-100 selection:bg-emerald-500 selection:text-white">
        @inertia
    </body>
</html>
