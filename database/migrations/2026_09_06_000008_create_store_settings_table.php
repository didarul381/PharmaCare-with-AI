...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('store_settings', function (Blueprint $table) {
            ...
            $table->string('address', 500)->nullable()->default('House #12, Road #4, Dhanmondi, Dhaka-1205');
            ...
            $table->string('receipt_footer', 500)->nullable()->default('Thank you for choosing PharmaCare AI! Quick healing.');
